...
import FeatureFilterContainer from "../components/FeatureFilterContainer";
import styles from "./SettingsFeatureRequests.module.css";

const SettingsFeatureRequests = () => {
  return (
    <div className={styles.settingsFeatureRequests}>
...
export default SettingsFeatureRequests;
import DashboardContainer from "../components/DashboardContainer";
import FeatureFilterContainer from "../components/FeatureFilterContainer";
import styles from "./SettingsFeatureRequests.module.css";
          ...
          <div className={styles.glasssetParent}>
            ...
            <div className={styles.groupFrame}>
              <div className={styles.rectangleContainer}>
                ...
                <div className={styles.raiseRequest}>Raise Request</div>
              </div>
            </div>
