  ...
  return (
    <div className={styles.userManagement}>
      ...
      <div className={styles.buttonParent}>
        ...
        <div className={styles.vendor1}>Vendor</div>
        <img className={styles.containerIcon} alt="" src="/container.svg" />
        <img className={styles.containerIcon1} alt="" src="/container.svg" />
        <img className={styles.containerIcon2} alt="" src="/container.svg" />
        <img className={styles.containerIcon3} alt="" src="/container.svg" />
        <img className={styles.containerIcon4} alt="" src="/container.svg" />
        <img className={styles.containerIcon5} alt="" src="/container.svg" />
        <img className={styles.containerIcon6} alt="" src="/container.svg" />
        <img className={styles.containerIcon7} alt="" src="/container.svg" />
        <img className={styles.containerIcon8} alt="" src="/container1.svg" />
        <img className={styles.containerIcon9} alt="" src="/container.svg" />
        <img className={styles.containerIcon10} alt="" src="/container.svg" />
        <div className={styles.tiffin}>{`Tiffin `}</div>
        <div className={styles.rishabh}>Rishabh</div>
        <div className={styles.vendor2}>Vendor</div>
        <div className={styles.vendor3}>Vendor</div>
        <div className={styles.laundry}>Laundry</div>
        <div className={styles.manisha}>Manisha</div>
        <div className={styles.vendor4}>Vendor</div>
        <div className={styles.vendor5}>Vendor</div>
        <div className={styles.tiffinlaundry}>Tiffin/Laundry</div>
        <div className={styles.shreya}>Shreya</div>
        <div className={styles.vendor6}>Vendor</div>
        <div className={styles.vendor7}>Vendor</div>
        <div className={styles.chef}>{`Chef `}</div>
        <div className={styles.kaustubh}>Kaustubh</div>
        <div className={styles.vendor8}>Vendor</div>
        <div className={styles.vendor9}>Vendor</div>
        <div className={styles.homemaker}>{`Homemaker `}</div>
        <div className={styles.dinesh}>Dinesh</div>
        <div className={styles.vendor10}>Vendor</div>
        <div className={styles.vendor11}>Vendor</div>
        <div className={styles.laundry1}>{`Laundry `}</div>
        <div className={styles.prakhar}>Prakhar</div>
        <div className={styles.vendor12}>Vendor</div>
        ...
        <div className={styles.changeRole}>Change Role</div>
        ...
        <div className={styles.usersList}>User’s List</div>
        <div className={styles.tushar}>Tushar</div>
        <div className={styles.admin2}>Admin</div>
        <div className={styles.admin3}>Admin</div>
        ...
        <div className={styles.vendor13}>Vendor</div>
              ...
              <div className={styles.listMenu8}>
                <div className={styles.content6}>
                  <img
                    ...
                    src="/manage-store.svg"
                  />
                  <div className={styles.text4}>User Management</div>
                </div>
              </div>
